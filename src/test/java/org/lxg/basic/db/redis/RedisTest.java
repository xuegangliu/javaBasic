...
public class RedisTest {
    ...
    public void sharedTest(){
        ...
        jedisShardInfo1.setPassword("lxgredis");
        List<JedisShardInfo> list = new LinkedList<JedisShardInfo>();
        list.add(jedisShardInfo1);
        ShardedJedisPool shardedJedisPool = RedisUtils.getConnetcShardedRedis( list );
...
//        hashOperate( jedis );
    ...
    private void insertData(Jedis jedis){
        jedis.flushDB();
        // string
        jedis.set( "a","123" );
        jedis.set( "b","456" );
        ...
        // list
        jedis.lpush("list1", "啊啊啊");
        jedis.lpush("list1", "不不不");
        jedis.lpush("list1", "错错错");
        ...
        jedis.zadd("zset", 9.0, "element002");
    ...
    private void stringOperate(Jedis jedis)
    {
    ...
    private void setOperate(Jedis jedis)
    {
    ...
    private void sortedSetOperate(Jedis jedis)
    {
    ...
    private void hashOperate(Jedis jedis)
    {
